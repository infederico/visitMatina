            ...
            <section className={styles.containerIn}>
                ...
                <div className={styles.containerMapa}>
                    <div className={styles.desarrollo}>
                        ...
                        <a className={styles.link} href="https://www.linkedin.com/in/noe-alonso-34437869" target="_blank" rel="noreferrer">Noé Alonso</a>
                        ...
                        <a className={styles.link} href="https://www.linkedin.com/in/ivan-federico-dev/" target="_blank" rel="noreferrer">Iván Federico</a> 
                        <a className={styles.link} href="https://www.linkedin.com/in/joseeduardoramirezhernandez" target="_blank" rel="noreferrer">Eduardo Ramírez</a>
