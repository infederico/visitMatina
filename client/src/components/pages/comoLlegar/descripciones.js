export const sanjosematina1 = `Para llegar de San José a Matina, hay tres 
...
export const sanjosematina2 = `En avión: Si desea llegar a Matina desde San
...
Terminal del Caribe tomar autobús Limón – Siquirres y 
